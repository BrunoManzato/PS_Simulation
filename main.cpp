/* ========================================================================
    ...
    This is the main file to make the GEANT4 Plastic scintillator simulation.
    ...
    Thanks to tutorials of Gustavo Valdiviesso, 2020
...
// We are going to import a pre-made physics list called "Shielding" that is very good for muons.
...
int main(int argc, char** argv){
	...
	if (argc == 1){
        ...
        uiManager->ApplyCommand("/process/verbose false");
